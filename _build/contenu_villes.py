...
SERVICES = {
 "elagage": dict(nom="Élagage et abattage", court="Élagage & abattage", page="elagage-abattage.html",
   ...
   desc="Élagueur {dans} ({cp}) : élagage, abattage par démontage, dessouchage et évacuation. Devis gratuit au 07 86 82 12 93."),
 "taille-de-haies": dict(nom="Taille de haies", court="Taille de haies", page="taille-de-haies.html",
   ...
   desc="Taille de haies {dans} ({cp}) : taille d'entretien, réduction de hauteur, haies mitoyennes, évacuation des déchets. Devis gratuit au 07 86 82 12 93."),
 "entretien-jardin": dict(nom="Entretien de jardin", court="Entretien de jardin", page="entretien-espaces-verts.html",
   ...
   desc="Entretien de jardin {dans} ({cp}) : tonte, taille, désherbage, ramassage des feuilles, contrat à l'année ou passage ponctuel. Devis gratuit au 07 86 82 12 93."),
 "debroussaillage": dict(nom="Débroussaillage et remise en état", court="Débroussaillage", page="debroussaillage-terrain.html",
   ...
   desc="Débroussaillage {dans} ({cp}) : terrain en friche, ronces, jardin abandonné, maison à vendre. Remise en état et évacuation des déchets verts. Devis au 07 86 82 12 93."),
 "amenagement-paysager": dict(nom="Aménagement paysager", court="Aménagement paysager", page="amenagement-paysager.html",
   ...
   desc="Aménagement paysager {dans} ({cp}) : création de jardin, plantations, engazonnement, allées et clôtures. Devis gratuit au 07 86 82 12 93."),
}
